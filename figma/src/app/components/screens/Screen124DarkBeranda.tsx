...
const trips = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=280&fit=crop&auto=format',
    tags: ['#Pantai', '#Alam'],
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&h=280&fit=crop&auto=format',
    tags: ['#Budaya', '#Pantai'],
...
export function Screen124DarkBeranda() {
  return (
    <div
      style={{
        width: '100%',
    ...
    >
      ...
      <div style={{ padding: '12px 22px 0' }}>
        <h2
          style={{ fontSize: 22, fontWeight: 800, color: D.text, margin: 0, letterSpacing: -0.5 }}
        >
          Perjalananku
        </h2>
      </div>
      ...
      {/* Tabs */}
      <div
        style={{ display: 'flex', margin: '16px 22px 0', borderBottom: `1.5px solid ${D.border}` }}
      >
        {[
          ...
          >
            <span
              style={{
                ...
                color: tab.active ? D.coral : D.muted,
              }}
            >
              {tab.label}
            </span>
            ...
            <div style={{ padding: '14px 16px 16px' }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  ...
                  <span style={{ fontSize: 12, color: D.muted, fontWeight: 500 }}>
                    {trip.dateRange}
                  </span>
                </div>
