...
React preview bundle untuk **112 layar** high-fidelity MVP. Sumber kebenaran inventori layar & design tokens untuk tim produk dan AI agents.
...
| Path | Isi |
|------|-----|
| `src/app/App.tsx` | Registry **112 layar** dikelompokkan **§1–§13** |
...
- Nomor layar = `Screen{N}` (bisa non-sequential, contoh: `Screen108`).
